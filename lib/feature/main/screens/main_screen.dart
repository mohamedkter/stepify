...
import 'package:stepify/feature/profile/show_profile/ui/screen/profile_screen.dart';
  ...
  List<Widget> get _screens => [
        MultiBlocProvider(
          providers: [
            ...
            BlocProvider(
              create: (_) => CategoryCubit(GetCategories(CategoryRepositoryImpl(
                  CategoryRemoteDataSourceImpl(FirebaseFirestore.instance))))
                ..fetchCategories(),
            ),
            BlocProvider(
              create: (_) => OfferCubit(GetOffers(OfferRepositoryImpl(
